:PROPERTIES:
:ID:       d8a136e2-5047-41d5-bcc6-61b1cc4dba01
:END:
#+TITLE: sweet spot interval training
#+CREATED:       [2020-11-18 Wed 21:34]
#+LAST_MODIFIED: [2021-05-27 Thu 19:02]
#+CONSTANTS: oldFTP=255
#+CONSTANTS: currentFTP=255

** Base I
   :PROPERTIES:
   :ID:       05f583f8-4f81-419d-bfc2-5ca600a34d09
   :END:
*** Base I Week 0
    :PROPERTIES:
    :ID:       d68c0230-26bd-4116-946f-d6690a67a7a6
    :END:
    | Day | Set         | Target | Rest   | REP | Instruction                |
    |-----+-------------+--------+--------+-----+----------------------------|
    |   0 | RAMP        |      - | -      |   - | -                          |
    |   1 | 3x12m       |    235 | 3m     |   7 | -                          |
    |   2 | 5x12m       |    232 | 4m     |   7 | -                          |
...
:END:
    ...
    |   2 | 5x12m        |    237 | 4m       |   7 | -           |
    |   3 | REC          |      - | -        |   - | 60m         |
    |   4 | 3x(15 + 15)m |    221 | 5m       |   7 | -           |
    |   5 | 3x(4x5) m    |    237 | r30sR12m |   7 | -           |
...
:END:
    ...
    |   0 | 5x12m     |    239 | 4m     |   7 | -           |
    |   1 | 3x15m     |    242 | 3m     |   7 | -           |
    |   2 | 3x(2x10)m |    237 | r1mR5m |   7 | -           |
    |   3 | REC       |      - | -      |   - | 60m         |
    |   4 | 4x(2x9)m  |    237 | r2mR7m |   7 | -           |
    |   5 | 5x15m     |    242 | 6m     |   7 | -           |
    #+TBLFM: @2$3=$currentFTP * 0.92;%.0f
...
:END:
    ...
    | s2  | -     |    248 | 5m   | -   | -                    |
    | s3  | -     |    243 | 5m   | -   | -                    |
    | 1   | 6x10m |      - | 3m   | 8   | rest after s1 and s2 |
    | s1  | -     |    219 | -    | -   | -                    |
    | s2  | -     |    230 | -    | -   | -                    |
    | s3  | -     |    211 | -    | -   | -                    |
    | s4  | -     |    219 | -    | -   | -                    |
...
*** Base I Week 4
    ...
    |-----+-----------+--------+-------+-----+----------------------|
    |   0 | 3x20m     |    235 | -     |   7 | -                    |
    |   1 | 3x20m     |      - | 3m    |   8 | rest after s1 and s2 |
    |   2 | 3x20m     |    237 | 3m    |   7 | Ramp as T; flat 2nd  |
    |   3 | REC       |      - | -     |   - | 60m                  |
    |   4 | 3x(3x10)m |    235 | r1R5m |   7 | -                    |
    |   5 | 4x20m     |    230 | 6m    |   7 | -                    |
    #+TBLFM: @2$3=$currentFTP * 0.92;%.0f
    #+TBLFM: @4$3=$currentFTP * 0.93;%.0f
...
*** Base I Week 5
    ...
    Rest week. 1h zone-2 rides.

** Base II
   :PROPERTIES:
   :ID:       7301ce4e-b887-474b-b3d0-194420aedfca
   :END:
*** Base II Week 0
    :PROPERTIES:
    ...
    |-----+-------+--------+------+-----+----------------|
    |   0 | FTP   |      - | -    |   - | -              |
    |   1 | 3x20m |    229 | 5m   |   7 | rest 1m in sub |
    |   2 | 3x20m |    237 | 12m  |   7 | rest 1m in sub |
    |   3 | REC   |      - | -    |   - | 60m            |
    |   4 | 5x15m |    239 | 7m   |   7 | -              |
    |   5 | 7x10m |    242 | 7m   |   8 | -              |
...
*** Base II Week 1
    ...
    |   3 | REC   |      - | -    |   - | 60m            |
    |   4 | 4x20m |    237 | 5m   |   7 | -              |
    |   5 | 3x20m |    237 | 12m  |   7 | rest 1m in sub |
    #+TBLFM: @2$3=$currentFTP * 0.92;%.0f
    #+TBLFM: @3$3=$currentFTP * 0.92;%.0f
    #+TBLFM: @4$3=$currentFTP * 0.91;%.0f
    #+TBLFM: @6$3=$currentFTP * 0.91;%.0f
...
*** Base II Week 2
    ...
    | Day | Set   | Target | Rest | REP | Instruction    |
    |-----+-------+--------+------+-----+----------------|
    |   0 | 3x20m |    246 | 12m  |   7 | rest 1m in sub |
    |   1 | 3x20m |    246 | 4m   |   7 | -              |
    |   2 | 7x10m |    246 | 5m   |   8 | -              |
    |   3 | REC   |      - | -    |   - | 60m            |
    |   4 | 4x20m |    240 | 6m   |   7 | -              |
    |   5 | 3x30m |    227 | 5m   |   7 | rest 1m in sub |
    #+TBLFM: @2$3=$currentFTP * 0.92;%.0f
    #+TBLFM: @3$3=$currentFTP * 0.92;%.0f
...
*** Base II Week 3
    ...
    |   0 | 5x15m     |    232 | 7m   |   7 | -           |
    |   1 | 4x15m     |    235 | 6m   |   7 | -           |
    |   2 | 4x(2x9)m  |    227 | 7m   |   8 | r2m         |
    |   3 | REC       |      - | -    |   - | 60m         |
    |   4 | 3x(3x10)m |    230 | 5m   |   7 | r1m         |
    |   5 | 7x10m     |    232 | 5m   |   7 | -           |
...
** General Build
   :PROPERTIES:
   :ID:       be720c18-e5a1-4263-bb27-0d3c21cf69ab
   :END:
...
** Short Power Build
   :PROPERTIES:
   :ID:       0520ce73-b89e-4678-8aa5-697f60010a67
   :END:
** Climb Hill
*** Climb Hill Week 0
    :PROPERTIES:
...
** extremely-hard-extension week
   ...
   :END:
    ...
    # knew my body has a limitation, I wanted to know how much can I
    # push. In that week, I cannot continue in Day 4.
